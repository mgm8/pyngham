...
This Python implementation of the protocol was inpired in part by the structure of the original implementation in C, but with main different being the use of a object oriented language. This way, there is a class for each of the three main possible uses of the protocol: The normal NGHam packets, the serial port packets, and the use of the extensions.
